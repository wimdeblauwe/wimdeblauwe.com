...
The next step will be to finish the development mode setup, so we can have live reload of the CSS and JS files in the library when running the sample application.
