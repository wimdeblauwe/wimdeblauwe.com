...
We need a way to test our component library.

TODO: Create a test application that uses the component library as it is developed so far and check that everything loads.
