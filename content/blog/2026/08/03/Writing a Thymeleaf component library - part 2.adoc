...
In https://www.wimdeblauwe.com/blog/2026/07/27/writing-a-thymeleaf-component-library/[part 1] we created a Thymeleaf component library that can be used in a Spring Boot application.
